document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
        ...
        activityCard.innerHTML = `
          ...
          <div class="participants-section">
            ...
            <ul class="participants-list">
              ${details.participants.map(p => `<li>${p} <button class="delete-participant" data-activity="${name}" data-email="${p}" title="Remove user">&times;</button></li>`).join("") || '<li><em>No one signed up yet</em></li>'}
            </ul>
          </div>
        `;
      ...
      // attach click handlers for delete buttons after list is rendered
